...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-white/[0.06]" style={{ background: "rgba(10, 10, 10, 0.85)", backdropFilter: "blur(30px)", WebkitBackdropFilter: "blur(30px)" }}>
